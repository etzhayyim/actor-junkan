...
;; Run:  bb --classpath 20-actors src/junkan/methods/test_scorecard.cljc
...
(def onto-path "data/ontology/ontology.junkan-gov.edn")
...
(deftest scorecard-is-read-only
  (let [src (slurp "src/junkan/methods/scorecard.cljc")]
