...
;; Run:  bb --classpath 20-actors src/junkan/methods/test_demography.cljc
...
(def societies-path "data/seed/seed.low-fertility-societies.edn")
(def onto-path "data/ontology/ontology.junkan-demography.edn")
