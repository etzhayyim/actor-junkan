...
(ns junkan.methods.validate
  ...
  a non-empty :errors means the substrate is broken. The validator covers the
...
#?(:clj
   (defn -main [& args]
     (let [seed (or (first args) "data/seed/seed.governance-asymmetry.edn")
           onto (or (second args) "data/ontology/ontology.junkan-gov.edn")
